...
const meta: Meta<typeof Table> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Display tabular data with sorting, pagination, and optional fill bars.',
      },
    },
  },
  argTypes: {
...
export const BrowserData: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Example showing browser analytics data with different column types.',
      },
    },
  },
};
...
export const WithoutFillBars: Story = {
  args: {
    data: {
      ...standardTableData,
      rows: standardTableData.rows.map(
        ({ fillRatio: _, ...rowWithoutFill }) => rowWithoutFill
      ),
    },
    loading: false,
    currentPage: 1,
